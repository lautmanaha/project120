...
של אותו מכון, ו"מבקר" Claude שמשווה את החילוץ לתמונת העמוד. סקר עם דגל נרשם ב-`db/quarantine.json` כ-`pending`,
נשאר מחוץ למודל, ונפתח Issue "[QA] סקר NNNN". תגובה ב-Issue שמתחילה ב-**אישור** או **דחייה** (workflow `qa_approve.yml`)
